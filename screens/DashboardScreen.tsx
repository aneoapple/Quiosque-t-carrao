...
const DashboardScreen: React.FC<DashboardProps> = ({ onNavigate }) => {
  ...
  return (
    <div className="space-y-6 pb-20">
      {/* HEADER ROSA - HOME */}
      <div className="bg-pink-200 p-4 -mx-4 -mt-4 md:-mx-6 md:-mt-6 mb-2 rounded-b-[2.5rem] shadow-sm relative flex items-center justify-between h-28 px-8">
        <div className="bg-white rounded-full p-2 w-12 h-12 flex items-center justify-center shadow-sm">
             <img 
        ...
        <div className="text-center">
            <h1 className="text-xl md:text-2xl font-black text-pink-900 tracking-tight leading-none mb-1">
              Quiosque T. Carrão
            </h1>
      ...
      {isAdmin ? (
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 gap-4 animate-fade-in">
            ...
            <MenuButton title="Dashboard KPI" target="kpi" color="bg-indigo-500" icon={<TrendingUp size={32} />} />

                        ...
                        <div key={emp.id} className="bg-white p-4 rounded-2xl border flex justify-between items-center shadow-sm">
                            <div>
                                ...
                                <div className="flex gap-2 mt-1">
                                    <span className="text-xs bg-slate-100 text-slate-600 px-2 py-0.5 rounded font-bold uppercase">{emp.role}</span>
                                    {emp.daily_meal_limit > 0 && (
                                        <span className="text-xs bg-green-100 text-green-700 px-2 py-0.5 rounded font-bold">
                                            Limite: R$ {emp.daily_meal_limit?.toFixed(2)}
                                        </span>
                                    )}
                                </div>
                            </div>
